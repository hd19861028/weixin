...
exports.reply_news = function(openid, msgs) {
	...
	for(var i = 0; i < msgs.length; i++) {
		var item = msgs[i];
		var temp = `<item><Title><![CDATA[${item.title}]]></Title><PicUrl><![CDATA[${item.pic}]]></PicUrl><Description><![CDATA[${item.description}]]></Description><Url><![CDATA[${item.link}]]></Url></item>`;
	}
	list+="</Articles>"
